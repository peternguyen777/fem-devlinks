        ...
        >
          ...
          <div className="my-6 flex-1 space-y-6 md:mb-10">
            <div className="w-full rounded-lg bg-[#FAFAFA] p-5 md:flex md:items-center">
              <p className="text-[#737373] md:w-[240px]">Profile picture</p>
              <div className="mt-4 flex h-[193px] w-[193px] cursor-pointer flex-col items-center justify-center rounded-xl bg-[#EFEBFF] md:ml-4 md:mt-0 md:flex-none">
                <svg
